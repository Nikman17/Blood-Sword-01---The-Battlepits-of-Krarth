...
- **Кольори вузлів**: початок, бої, параграфи для окремих класів (Мудрець,
  Пройдисвіт, Зачаровувач, Воїн) і всі 13 кінцівок — від повної перемоги
  (§540) та «сірої» кінцівки (§257) до пасток, загибелей і особливих
  параграфів «поверніться туди, звідки прийшли».
- **Пунктирні дуги** — зворотні переходи; опційно вмикається їхня глибина
  (↩ на скільки кроків назад по сюжету вони повертають).
